<div class="cost-page">
    <div class="row">
        <form class="cost-form" wire:submit="save">
            <div class="row">
                <div class="col">
                    <div class="input-field" x-init="$refs.costField.focus()">
                        <i class="material-icons prefix">attach_money</i>
                        <input required id="icon_prefix" type="number" class="center-align price-field" wire:model="price" x-ref="costField">
                    </div>
                </div>
                <div class="col">
